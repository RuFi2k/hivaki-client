...
const qualities: IQuality[] = [
  ...
  },
  {
    ...
    description: 'Только лучшее оборудование и расходники. Никаких алергенов - лишь качественный сервис, советы по домашнему уходу и результат работы, сделаный с любовью.',
  },
  {
